...
[ ] Comprehensive user guide - [ ] Tutorial: building a todo app - [ ]
Example: file browser - [ ] Example: form with validation
...
| *M4: Production Ready* | 5     | Optimised, documented, tested                                | WIP    |
