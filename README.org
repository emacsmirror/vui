...
#+begin_quote
*Note:* This is a fresh library under active development. The API may change based on real-world usage and feedback.
#+end_quote
...
| =use-async=    | Async data loading with cache              |
...
- [[https://github.com/d12frosted/vulpea-ui][vulpea-ui]] — Sidebar UI for vulpea notes
- [[https://github.com/d12frosted/vulpea-journal][vulpea-journal]] — Journaling system with calendar widgets
- [[https://github.com/d12frosted/brb][brb]] — Barberry Garden management system
