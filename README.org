...
<table>
  <tr>
    <td align="center" valign="top" width="50%">
      <a href="docs/examples/15-ci-dashboard.el"><strong>CI Dashboard</strong></a> <sub>(real, over <code>gh</code>)</sub><br/>
      <sub>live GitHub Actions runs, drill into jobs and steps, stream logs</sub>
      <br/><br/>
      <a href="docs/images/15-ci-dashboard.gif"><img src="docs/images/15-ci-dashboard.gif" alt="CI dashboard demo" width="400"/></a>
    </td>
    <td align="center" valign="top" width="50%">
      <a href="docs/examples/14-claude-chat.el"><strong>Claude Chat</strong></a><br/>
      <sub>live chat against <code>claude -p</code>, streamed through <code>vui-stream</code></sub>
      <br/><br/>
      <a href="docs/images/14-claude-chat.gif"><img src="docs/images/14-claude-chat.gif" alt="Claude Chat demo" width="400"/></a>
    </td>
  </tr>
  <tr>
    <td align="center" valign="top" width="50%">
      <a href="docs/examples/11-dashboard.el"><strong>CI Pipeline Dashboard</strong></a> <sub>(simulated)</sub><br/>
      <sub>colored status and live progress gauges</sub>
      <br/><br/>
      <a href="docs/images/11-dashboard.gif"><img src="docs/images/11-dashboard.gif" alt="CI pipeline dashboard demo" width="400"/></a>
    </td>
    <td align="center" valign="top" width="50%">
      <a href="docs/examples/10-pomodoro.el"><strong>Pomodoro Timer</strong></a><br/>
      <sub>a countdown driven by a timer effect</sub>
      <br/><br/>
      <a href="docs/images/10-pomodoro.png"><img src="docs/images/10-pomodoro.png" alt="Pomodoro timer" width="400"/></a>
    </td>
  </tr>
</table>
#+end_html

More runnable examples are listed [[#examples][below]].
...
|----+-----------------------+-----------------------------------------------------------------------------------------|
| 01 | [[file:docs/examples/01-hello-world.el][Hello World]]           | Basics from the getting started guide                                                   |
| 02 | [[file:docs/examples/02-todo-app.el][Todo App]]              | Add, remove, and filter items                                                           |
| 03 | [[file:docs/examples/03-forms.el][Forms]]                 | Form validation, multi-step wizards, settings                                           |
| 04 | [[file:docs/examples/04-file-browser.el][File Browser]]          | Directory navigation with sorting and search                                            |
| 05 | [[file:docs/examples/05-wine-tasting.el][Wine Tasting]]          | Dynamic tables with interactive cells and computed statistics                           |
| 06 | [[file:docs/examples/06-collapsible.el][Collapsible]]           | Expandable/collapsible sections, FAQ style, nesting                                     |
| 07 | [[file:docs/examples/07-semantic-text.el][Semantic Text]]         | Headings, emphasis, and status messages with customizable faces                         |
| 08 | [[file:docs/examples/08-typed-fields.el][Typed Fields]]          | Integer/float/symbol input with validation                                              |
| 09 | [[file:docs/examples/09-inline-form.el][Inline Forms]]          | Ephemeral, validated forms that expand at point                                         |
| 10 | [[file:docs/examples/10-pomodoro.el][Pomodoro Timer]]        | Countdown driven by a timer effect, work/break sessions                                 |
| 11 | [[file:docs/examples/11-dashboard.el][CI Pipeline Dashboard]] | Live table with colored status and progress gauges (simulated)                          |
| 12 | [[file:docs/examples/12-flex-layout.el][Flex Layout]]           | Window-filling fields, =:justify= modes, and =:grow= panels with vui-flex               |
| 13 | [[file:docs/examples/13-agent-chat.el][Agent Chat]]            | A transcript that streams above a persistent input box with =vui-stream=                |
| 14 | [[file:docs/examples/14-claude-chat.el][Claude Chat]]           | A live chat against the =claude -p= CLI, streamed through =vui-stream=                  |
| 15 | [[file:docs/examples/15-ci-dashboard.el][CI Dashboard]]          | A *real* GitHub Actions dashboard over =gh=: async run table, drill-down, log streaming |
